        ...
        <div className="container flex items-center justify-between">
            ...
            <div className="flex justify-between items-center gap-6">
                <div classname="relative group hidden sm:block">
                    <input type="text" placeholder="Search" className="w-[200px] sm:w-[200px] group-hover:w-[300px] transition-all duration-300 rounded-lg border-gray-300 py-1 px-2 text-sm focus:outline-none focus:border focus:border-primary dark:border-gray-500 dark-bg-slate-800" />
